...
var seedBugs = function () {
    ...
    var bugs = [
        ...
        },
        {
            ...
            status: 'new',
            protocol: 'https',
            formComments: 'The site is running very slowly and images do not appear.',
            assignment: 'Ashley',      
            applicationId: 2,      
            platform: 'MacIntel',
            browser:'Chrome',
            ...
            difficulty: 1, 
            pathName: '/',
            createdAt: '2016-07-11 13:09:14.53-04'
        },
                {
            appId: '1248wqt',
            status: 'resolved',
            doNotTrack: 1,
            protocol: 'https',
            formComments: 'The submit button doesn\'t process my payment. 💸',
            assignment: 'Ashley',   
            applicationId: 2,         
            platform: 'MacIntel',
            browser:'Safari',
            ...
            difficulty: 1, 
            pathName: '/bill-pay',
            createdAt: '2016-07-10 13:09:14.53-04'
        },
                {
            appId: '1248wqt',
            status: 'in-progress',
            doNotTrack: 1,
            protocol: 'https',
            formComments: 'The email address on the help page returns an undeliverable message.',
            ...
            doNotTrack: 1,
            protocol: 'https',
            formComments: 'How can I get in contact with a real human? 🤖🤖🤖',
            assignment: 'unassigned',     
            applicationId: 2,       
            platform: 'MacIntel',
            browser:'Internet Explorer',
            ...
            status: 'new',
            protocol: 'https',
            formComments: 'This site was previously better; now it doesn\'t work well.',
            assignment: 'unassigned',  
            applicationId: 3,          
            platform: 'MacIntel',
            browser:'Chrome',
            ...
            doNotTrack: 1,
            protocol: 'https',
            formComments: 'Much of the text 📝 on this page is missing.',
            assignment: 'unassigned', 
            applicationId: 3,           
            platform: 'MacIntel',
            browser:'Chrome',
            ...
            status: 'new',
            protocol: 'https',
            formComments: 'How come the documentation on your site is unclear?',
            assignment: 'unassigned',  
            applicationId: 3,          
            platform: 'MacIntel',
            browser: 'Safari',
